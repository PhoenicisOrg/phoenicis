...
public class RegistryWriterTest {
    ...
    public void testGenerateRegFile() throws Exception {
        ...
        RegistryValue<BinaryValueType> testNodeD = new RegistryValue<>("D",
                new BinaryValueType(new byte[] { 0, 1, 2 }));

        RegistryValue<DwordValueType> testNodeE = new RegistryValue<>("E", new DwordValueType(10L));

        RegistryValue<ExpandableValueType> testNodeF = new RegistryValue<>("F", new ExpandableValueType("Content"));

        RegistryValue<MultiStringValueType> testNodeG = new RegistryValue<>("G", new MultiStringValueType("Content2"));

        RegistryValue<StringValueType> testNodeH = new RegistryValue<>("G", new StringValueType("Content3"));
    ...
    public void testGenerateRegFileRemoveAValue() {
        ...
        AbstractRegistryNode testRemoveNode = new RegistryKey("HKEY_CURRENT_USER").addDeepChildren("test1", "test2",
                "test3");
