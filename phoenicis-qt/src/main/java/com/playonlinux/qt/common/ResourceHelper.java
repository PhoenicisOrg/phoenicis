...
public final class ResourceHelper {
    ...
    public static QPixmap getPixmap(URL source) {
        try {
            ...
            log.error("Failed to load pixmap", e);
            return new QPixmap();
        }
    }
    ...
    public static String getStyleSheet(Class<?> c, String resourcePath) {
        ...
        try {
            ...
            log.error("Failed to get stylesheet", e);
        }
     ...
     * 
     * @param stream
     *            Stream to turn into a QIODevice
    ...
    /**
     * Generate a QIODevice for the resource with the given name of the given
     * class
     * 
     * @param c
     *            Class that should be used for locating the resource
     * @param resourcePath
