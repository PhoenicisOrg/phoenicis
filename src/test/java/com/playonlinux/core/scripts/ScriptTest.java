...
public class ScriptTest {
    ...
    public void testExtractSignature_bashScriptWithSignature_extracted()
        ...
        Script legacyScriptWithSignature = new ScriptFactoryDefaultImplementation()
                .createInstance(new File(this.getClass().getResource("legacyScriptExampleWithSignature.sh").getPath()));
    ...
    public void testExtractSignature_bashScriptWithSignatureCRLF_extracted()
            throws IOException, ParseException, ScriptFailureException {
        Script legacyScriptWithSignature = new ScriptFactoryDefaultImplementation().createInstance(
    ...
    public void testExtractSignature_bashScriptWithNoSignature_exceptionThrown()
        ...
        Script legacyScriptWithoutSignature = new ScriptFactoryDefaultImplementation()
                .createInstance(new File(this.getClass().getResource("legacyScriptExample.sh").getPath()));
        legacyScriptWithoutSignature.extractSignature();
    }

    @Test
    public void testExtractSignature_pythonScriptWithSignature_extracted()
            throws IOException, ParseException, ScriptFailureException {
        Script script = new ScriptFactoryDefaultImplementation()
                .createInstance(new File(this.getClass().getResource("scriptExampleWithSignature.py").getPath()));
    ...
    @Test
    public void testExtractContent_pythonScriptWithSignature_extracted()
            throws IOException, ParseException, ScriptFailureException {
        final Script script = new ScriptFactoryDefaultImplementation()
                .createInstance(new File(this.getClass().getResource("scriptExampleWithSignature.py").getPath()));
    ...
    @Test(expected = ScriptFailureException.class)
    public void testExtractSignature_pythonScriptWithNoSignature_exceptionThrown()
            throws IOException, ScriptFailureException {
        Script script = new ScriptFactoryDefaultImplementation()
                .createInstance(new File(this.getClass().getResource("scriptExample.py").getPath()));
    ...
    public void testExtractSignature_emptyScript_exceptionThrown() throws IOException, ScriptFailureException {
        Script script = new ScriptFactoryDefaultImplementation()
                .createInstance(new File(this.getClass().getResource("emptyScript").getPath()));
        script.extractSignature();
    }
    ...
    public void testExtractScript_withRealScript_extracted() throws IOException, ScriptFailureException {
        Script legacyScriptWithSignature = new ScriptFactoryDefaultImplementation()
                .createInstance(new File(this.getClass().getResource("realScript.sh").getPath()));
