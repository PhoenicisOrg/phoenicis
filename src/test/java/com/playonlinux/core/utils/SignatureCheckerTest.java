...
public class SignatureCheckerTest {
    ...
    @Test
    public void testSignatureChecker_withValidSignature_returnTrue() throws IOException, CMSException, PGPException,
            NoSuchProviderException, SignatureException, com.playonlinux.core.gpg.SignatureException {
