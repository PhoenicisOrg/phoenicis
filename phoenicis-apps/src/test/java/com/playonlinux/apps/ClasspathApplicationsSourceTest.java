...
public class ClasspathApplicationsSourceTest {
    ...
    private final ApplicationsSource applicationsSource = new ClasspathApplicationsSource("/com/playonlinux/apps/repositoryTest", resourceResolver, new ObjectMapper());
