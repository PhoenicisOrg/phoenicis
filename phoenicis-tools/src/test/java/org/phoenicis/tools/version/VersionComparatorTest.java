...
public class VersionComparatorTest {
    ...
    public void testCompare_HigherVersion() {
        ...
        assertTrue(versionComparator.compare(new Version("5.2.1"), new Version("4.2.1")) > 0);

        assertTrue(versionComparator.compare(new Version("4.2.2"), new Version("4.1.3")) > 0);
    }
    ...
    public void testCompare_LowerVersion() {
        ...
        assertTrue(versionComparator.compare(new Version("4.2.1"), new Version("5.2.1")) < 0);

        assertTrue(versionComparator.compare(new Version("4.1.3"), new Version("4.2.2")) < 0);
    }
