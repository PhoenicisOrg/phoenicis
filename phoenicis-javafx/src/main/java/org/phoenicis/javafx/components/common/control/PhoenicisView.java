...
/**
 * The {@link PhoenicisView} is the core component of the Phoenicis JavaFX GUI.
 * <p>
 * It encloses common functionality (e.g. the library) inside a {@link Tab} which is presented in the main menu.
 * Every {@link PhoenicisView} is split into three basic components: a sidebar, the content and an optional details
 * panel.
 * <p>
 * The Sidebar is shown on the left side. It shall allow for a quick navigation in the categories which structure the
 * content.
 * <p>
 * The content is the main content which presents the functionality of this particular {@link PhoenicisView}.
 * <p>
