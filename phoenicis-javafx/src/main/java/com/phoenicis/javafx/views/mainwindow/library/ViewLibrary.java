...
import com.phoenicis.javafx.views.common.widget.MiniatureListWidget;
import com.phoenicis.javafx.views.mainwindow.MainWindowView;
import com.phoenicis.javafx.views.mainwindow.ui.LeftBarTitle;
import com.phoenicis.javafx.views.mainwindow.ui.LeftButton;
import com.phoenicis.javafx.views.mainwindow.ui.LeftGroup;
import com.phoenicis.javafx.views.mainwindow.ui.LeftSpacer;
...
public class ViewLibrary extends MainWindowView {
    ...
    public ViewLibrary(String applicationName) {
        ...
        this.runScript = new LeftButton("/com/phoenicis/javafx/views/mainwindow/library/script.png",
                translate("Run a script"));
        this.runConsole = new LeftButton("/com/phoenicis/javafx/views/mainwindow/library/console.png",
    ...
    private LeftGroup shortcutGroup(ShortcutDTO shortcut) {
        ...
        final LeftButton runButton = new LeftButton("/com/phoenicis/javafx/views/mainwindow/library/play.png", translate("Run"));
        final LeftButton stopButton = new LeftButton("/com/phoenicis/javafx/views/mainwindow/library/stop.png", translate("Close"));
        final LeftButton uninstallButton = new LeftButton("/com/phoenicis/javafx/views/mainwindow/library/remove.png", translate("Uninstall"));
