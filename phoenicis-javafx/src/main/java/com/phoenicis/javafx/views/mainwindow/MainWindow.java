...
import com.phoenicis.javafx.JavaFXApplication;
import com.phoenicis.javafx.views.common.PhoenicisScene;
...
public class MainWindow extends Stage {
    ...
    public MainWindow(String applicationName,
        ...
        this.getIcons().add(new Image(JavaFXApplication.class.getResourceAsStream("/com/phoenicis/javafx/views/common/phoenicis.png")));
