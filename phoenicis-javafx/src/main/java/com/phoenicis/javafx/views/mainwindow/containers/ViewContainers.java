...
package com.phoenicis.javafx.views.mainwindow.containers;

import com.phoenicis.containers.dto.ContainerDTO;
    ...
    public void populate(List<ContainerDTO> containers) {
        Platform.runLater(() -> {
            ...
            for (ContainerDTO container : containers) {
                final LeftToggleButton containerButton = new LeftToggleButton("/com/phoenicis/javafx/views/mainwindow/containers/container.png", container.getName());
